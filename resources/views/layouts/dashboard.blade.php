            ...
            <aside class="app-sidebar">
                <div class="app-sidebar__logo">
                    <a class="header-brand" href="index-2.html">
                        <img src="/admin_assets/assets/images/brand/logo.png" class="header-brand-img desktop-lgo"
                            alt="Admintro logo">
                        <img src="/admin_assets/assets/images/brand/logo1.png" class="header-brand-img dark-logo" alt="Admintro logo">
                        <img src="/admin_assets/assets/images/brand/favicon.png" class="header-brand-img mobile-logo"
                            alt="Admintro logo">
                        <img src="/admin_assets/assets/images/brand/favicon1.png" class="header-brand-img darkmobile-logo"
                            alt="Admintro logo">
                    </a>
                </div>
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        <div class="user-pic">
                            <img src="/admin_assets/assets/images/users/2.jpg" alt="user-img" class="avatar-xl rounded-circle mb-1">
                        </div>
                        <div class="user-info">
                ...
                <ul class="side-menu app-sidebar3">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('admin.add-product') }}">
                            ...
                            <span class="side-menu__label">Add Products</span><span></a>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('admin.add-category') }}">
                            ...
                            <span class="side-menu__label">Add Categories</span><span></a>

                    </li>

                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('admin.all-products') }}">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                viewBox="0 0 24 24" width="24">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                                <path
                            ...
                            <span class="side-menu__label">All Products</span><span></a>
                                ...
                                <div class="d-flex order-lg-2 ml-auto">
                                    ...
                                    <div class="dropdown profile-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                                            ...
                                            @auth
                                            <a class="dropdown-item d-flex" onclick="logout()" href="{{route('logout')}}">
                                                <svg class="header-icon mr-3" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2021 <a href="index.html#">Admintro</a>. Designed by <a href="index.html#">Spruko
