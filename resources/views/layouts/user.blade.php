...
<head>
    ...
    <!-- Title -->
    <title>Mr and Miss Melamin Afrique 2021</title>
                ...
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        <div class="dropdown user-pro-body text-center">
                            @if (!Auth::user()->image)
                            <div class="user-pic">
                                <img src="/assets/avatar/avatar_01.png" alt="user-img"
                            ...
                            @else
                            <div class="user-pic">
                                <img src="/storage/users/{{ Auth::user()->image }}" alt="user-img"
                                    class="avatar-xl rounded-circle mb-1">
                            </div>
                            @endif
                            ...
                            <div class="user-info">
                                ...
                                <span
                                    class="text-muted app-sidebar__user-name text-sm">{{  Auth::user()->votes }}</span>
                            </div>
                        </div>
                    ...
                    <ul class="side-menu app-sidebar3">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" href="{{ route('user.add-content') }}">
                                <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                    viewBox="0 0 24 24" width="24">
                                    <path d="M0 0h24v24H0V0z" fill="none" />
                                    <path
                                ...
                                <span class="side-menu__label">Add Content</span><span
                                    class="badge badge-danger side-badge"></span></a>
                        </li>
                        ...
                        <ul class="slide-menu">
                            <li class="sub-slide">
                                <a class="sub-side-menu__item" data-toggle="sub-slide" href="index.html#"><span
                    ...
                    <div class="container">
                        <div class="row align-items-center flex-row-reverse">
                            <div class="col-md-12 col-sm-12 text-center ">
                                Copyright © 2021 <a href="index.html#">Mr and Miss Melanin Afrique 2021</a>.<a
