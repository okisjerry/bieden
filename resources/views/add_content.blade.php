...
<!-- user details wrapper start -->
<div class="user-details-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-lg-9">
                <!-- user details inner end -->
                <div class="user-details-inner">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="user-large-slider mb-20 slick-arrow-style_2">
                                @foreach ($images as $image)
                                <div class="pro-large-img img-zoom" id="img1">
                                    <img src="/storage/products/{{ $image->name }}" alt="" />
                                </div>
                                @endforeach
                            ...
                            <div class="pro-nav slick-padding2 slick-arrow-style_2">
                               @foreach ($images as $image)
                               <div class="pro-nav-thumb"><img src="/storage/products/{{ $image->name }}" alt="" /></div>
                               @endforeach
                        ...
                        <div class="col-lg-6">
                            <div class="product-details-des mt-md-34 mt-sm-34">
                                ...
                                <div class="pricebox">
                                    <span class="regular-price">N{{number_format( $product->price) }}</span>
                                </div>
                        ...
                        <div class="product-item fix">
                            <div class="product-thumb">
                                <a href="product-details">
                                    <img src="/storage/product/product-imgage" class="img-pri" alt="">
                                    <img src="/storage/product/product-imgage" class="img-sec" alt="">
                                </a>
                        ...
                        <div class="category-carousel-active row" data-row="4">
                            ...
                            <div class="col">
                                <div class="category-item">
                                    ...
                                    <div class="category-content">
                                        <h4><a href="product-details">{{ $product->name }}</a></h4>
                                        <div class="price-box">
                                            <div class="regular-price">
                                                $140.00
                                            </div>
